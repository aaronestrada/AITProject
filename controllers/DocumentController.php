    ...
    public function actionAddtocart() {
        ...
        if ($this->request->isAjaxRequest() && $this->request->isPostRequest()) {
            ...
            if ($objDocument != null) {
                ...
                //Step 2: Verify that document is not already in cart
                ...
                if ($documentCartCount == 0) {
                    //Step 3: Verify that document is not already in purchased items
                    ...
                    if ($purchaseDocumentCount == 0) {
                        //Step 4: if document not found in cart and in purchased items, add to cart
        ...
        $resultData['alertHtml'] = $this->render('partial/addToCartAlert', ['errorList' => $errorList], false);
