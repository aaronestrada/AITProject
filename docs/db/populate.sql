...
('6', 'National Oceanic and Atmospheric Administration', 'https://www.ncdc.noaa.gov', 'ncei.orders@noaa.gov', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO `document` 
(`id`, `author_id`, `status`, `name`, `description`, `details_link`, `price`, `created_at`, `modified_at`, `published_at`, `filename`) 
VALUES 
('1', '6', '1', 'Buffalo Niagara International Airport Weather', 'Hourly Observation. Month/Year: 05/2016; Station Location: BUFFALO NIAGARA INTERNATIONAL AP (14733); Lat: 42.940 Lon: -78.735; Elev: 716 ft. above sea level', 'http://dati.retecivica.bz.it/it/dataset/unita-organizzative-della-provincia-autonoma-di-bolzano', '10.99', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2015-08-05 15:19:03', 'buffalo-05-2016.csv'),
('2', '2', '1', 'Associazioni turistiche in Alto Adige', 'Il dataset contiene i contatti delle associazioni turistiche in Alto Adige', 'http://dati.retecivica.bz.it/it/dataset/uffici-turistici-dell-alto-adige', '5.50', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2016-02-05 10:00:03', 'elecnoassociazioni-turistichealto-adige.csv'),
('3', '2', '1', 'Consorzi turistici in Alto Adige', 'Il dataset contiene i contatti dei consorzi turistici in Alto Adige', 'http://dati.retecivica.bz.it/it/dataset/enti-turistici-dell-alto-adige', '6.00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2016-02-05 10:10:03', 'elencoconsorzituristici.csv'),
('4', '3', '1', 'Turismo: conto satellite', 'Il dataset fornisce i dati statistici relativi alla all’offerta e al consumo turistico interno nei comuni della Provincia Autonoma di Bolzano', 'http://dati.retecivica.bz.it/it/dataset/turismo-conto-satellite', '10.00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2009-03-03 14:50:55', 'TSA_CST_2008.csv'),
('5', '3', '1', 'Pensioni', 'Il dataset fornisce i dati statistici relativi al sistema pensionistico nella Provincia Autonoma di Bolzano.', 'http://dati.retecivica.bz.it/it/dataset/pensioni', '22.40', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2016-02-02 11:22:33', 'mit42_2015-tabellen.csv'),
('6', '3', '1', 'Agricoltura e foreste: Allevamenti', 'Il dataset fornisce i dati statistici relativi all’allevamento nella Provincia Autonoma di Bolzano.', 'http://dati.retecivica.bz.it/it/dataset/agricoltura-e-foreste-allevamenti', '6.50', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2016-02-02 12:13:14', 'kapitel_3.csv'),
('7', '3', '1', 'Agricoltura e foreste: informazioni varie', 'Il dataset fornisce varie tipologie di dati statistici relativi a vari ambiti agricoli e forestali della Provincia Autonoma di Bolzano.', 'http://dati.retecivica.bz.it/it/dataset/agricoltura-e-foreste-informazioni-varie', '6.50', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2016-02-02 12:15:50', 'kapitel_5.csv'),
