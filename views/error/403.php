...
<div class="content">
    <h2>Error 403</h2>
    <h3>Cannot access to this resource</h3>
    <hr>
    <div class="col-size-8">
        <p>You need to <a href="/user/login" class="decor">login</a> to access this page. If you are having any trouble, please <a
                href="mailto:aaron.estrada.poggio@gmail.com" class="decor">contact us</a>.
        </p>
    </div>
